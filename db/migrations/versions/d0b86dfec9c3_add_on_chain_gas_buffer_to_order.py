...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("escrow_wallet_address", sa.String(length=255), nullable=True),
        sa.Column("escrow_wallet_private_key_enc", sa.String(length=512), nullable=True),
        sa.Column("on_chain_tx_hash", sa.String(length=255), nullable=True),
        sa.Column("on_chain_status", sa.String(length=50), nullable=False),
